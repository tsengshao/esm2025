...
!!debug new
!if(cell_timestep0.eq.1)then
!print*, cell_timestep0, cell_id0, largest_forward_link, status_forward, largest_backward_link, status_backward
!elseif(cell_timestep0.eq.2)then
!stop
!endif
!!debug new
